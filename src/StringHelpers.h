...
namespace cpp {
    ...
    public:
        ...
        static void CopyStr(char* dst, const size_t buff_size, char const* src)
		{
            strcpy_s(dst, buff_size, src);
        }

        static void CatStr(char* dst, const size_t buff_size, char const* src)
        {
        ...
        static const char* SubStr(const char* string, const char* find)
        {
            return strstr(string, find);
        }

        static char* SubStr(char* string, const char* find)
        {
            return strstr(string, find);
        }
    };
